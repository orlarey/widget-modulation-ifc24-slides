...
\newcommand{\itv}[1]{\mathsf{itv}|[#1|]}

\newcommand{\FIR}{\mathsf{FIR}}
\newcommand{\IIR}{\mathsf{IIR}}

\newcommand{\fir}[1]{\mathsf{fir}|[#1|]}
\newcommand{\iir}[2]{\mathsf{iir}|[#2|]_{#1}}

% Lowest and Highest Value of a signal
\newcommand{\low}[1]{\mathsf{lo}|[#1|]}
\newcommand{\high}[1]{\mathsf{hi}|[#1|]}
\newcommand{\depi}[1]{\mathsf{dep_I}|[#1|]}
\newcommand{\depm}[1]{\mathsf{dep_M}|[#1|]}
\newcommand{\deph}[1]{\mathsf{dep_H}|[#1|]}
\newcommand{\rec}[1]{\mathsf{rd}|[#1|]}
\newcommand{\rgraph}[1]{\mathsf{rg}|[#1|]}

% instructions <--> destination
\newcommand{\idest}[1]{\mathcal{D}|[#1|]}
\newcommand{\dinst}[1]{\mathcal{I}|[#1|]}
...
\newcommand{\od}[1]{\mathtt{ondemand} (#1)}
...
\newcommand{\XS}{\mathbb{S}_e} % eXtended Signals
\newcommand{\FX}{\mathbb{X}} % Recursive Signal Identifiers
...
\newcommand{\DS}{\mathbb{D}} % Memory Identifiers

% Ligatures
\mathlig{-*>}{\:\overrightarrow{\star}\:}
\mathlig{<*-}{\:\overleftarrow{\star}\:}
\mathlig{<*}{\!\downarrow\!}
\mathlig{<*}{\!\downarrow\!}
\mathlig{*>}{\!\uparrow\!}
\mathlig{<>}{\mid}
...
$endif$
$if(lhs)$
\lstnewenvironment{code}{\lstset{language=Haskell,basicstyle=\small\ttfamily\color{yotxt},backgroundcolor=\color{yobg}}}{}
$endif$
